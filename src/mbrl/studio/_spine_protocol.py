...
SERVED = {"hello", "pull.runs", "pull.metric", "pull.metric_since", "pull.datasets", "pull.surface", "submit.spec", "submit.sweep", "pull.run_status", "pull.launched", "pull.log", "run.cancel", "search.submit", "search.status", "search.tick", "pull.artifacts", "pull.sweep", "pull.diagnostics", "error"}
